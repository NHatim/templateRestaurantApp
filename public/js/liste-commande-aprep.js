  ...
  fetch('/restaurant/api')
    ...
    .then(data => {
      ...
      tabCommande.forEach(commande => {
        ...
        if(commande.restaurant.nom === findResto.nom && commande.etatCommande === "aprep"){
          diffMilli = diffMilli + (commande.datePreparation-commande.dateCreation);
      ...
      Délai préparation minutes : ${diffMins / findResto.commandePrep} |
